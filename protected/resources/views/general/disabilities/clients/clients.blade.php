        ...
        var TableDatatablesManaged = function () {
            ...
            var initTable1 = function () {
                ...
                table.dataTable({
                    ...
                    "ajax": {
                        "url": "{{url('disabledclients')}}", // ajax source
                    },
                    "order":false
                    ...
                    "fnDrawCallback": function (oSettings) {
                        $(".addRecord").click(function(){
                            ...
                            modaldis+= '<span id="myModalLabel" class="caption caption-subject font-blue-sharp bold uppercase" style="text-align: center"><i class="fa fa-plus font-blue-sharp"></i>Disability register</span>';
                            modaldis+= '</div>';
...
@section('breadcrumb')
    <ul class="page-breadcrumb ">
        ...
        <li>
            <span class="active">Clients search </span>
        </li>
    </ul>
@stop
@section('contents')
