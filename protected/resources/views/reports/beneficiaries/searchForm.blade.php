    ...
    <div class="col-md-12">
        <div class="portlet light bordered">
            <div class="portlet-body form">
                {!! Form::open(array('url'=>'reports/beneficiaries/generate','role'=>'form','id'=>'formItemsDistributionReport')) !!}
                <div class="panel panel-flat">


                    <div class="panel-body">
                        <fieldset class="scheduler-border">
                            <legend class="text-bold">Beneficiaries Report</legend>
                            @if (session('message'))
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <select  class="form-control" data-live-search="true" data-width="100%" name="report_type" id="report_type" data-placeholder="Choose an option...">
                                            <optgroup label="Report Type">
                                                <option value="1">List of beneficiaries</option>
                                            </optgroup>
                                        </select>
                                    </div>
                                </div>
