            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">Manage Camps</span>
                    </div>
                        ...
                        @if(count($camps)>0)
                            @foreach($camps as $camp)
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        @if(is_object($camp->region) && $camp->region != null && $camp->region !="")
                                        {{$camp->region->region_name}}
                                            @endif
                                    </td>
                                    <td>
                                        @if(is_object($camp->district) && $camp->district != null && $camp->district !="")
                                        {{$camp->district->district_name}}
                                            @endif
                                    </td>
                                    <td>
                                        {{$camp->status}}
