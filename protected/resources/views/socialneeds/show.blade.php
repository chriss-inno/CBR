        ...
        <div class="form-body">
            <div class="form-group" id="itemsdispatch">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="progress_number" id="progress_number" disabled value="{{$need->progress_number}}">
                </div>
                <div class="form-group">
                    <label>Assistance he/she needs</label>
                    <textarea class="form-control" name="assistance" id="assistance" disabled>{{$need->progress_number}}</textarea>
                </div>
