...
<div class="portlet light bordered">
        ...
        <div class="form-body">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-8 col-lg-8">
                                ...
                                <input type="text" class="form-control" name="category" id="category" value="{{$group->category}}">
                        </div>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-4 col-sm-4 col-xs-4 col-lg-4">
                            ...
                            <input type="text" class="form-control" name="activity" id="activity" value="{{$group->activity}}">
                        </div>
                        <div class="col-md-4 col-sm-4 col-xs-4 col-lg-4">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-4 col-lg-4">
                            ...
                            <select name="nationality" id="nationality" class="form-control">
                                ...
                                @if($group->nationality != "")
                                    <option value="{{$group->nationality}}" selected>{{$group->nationality}}</option>
                                @endif
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="address" id="address" value="{{$group->address}}">
            </div>
            <div class="form-group">
                <label>Source of Funding</label>
                <input type="text" class="form-control" name="funding_source" id="funding_source" value="{{$group->funding_source}}">
            </div>
        </div>
