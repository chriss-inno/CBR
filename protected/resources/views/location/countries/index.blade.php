...
@section('custom-scripts')
    <script>
        $("#addRegion").click(function(){
            ...
            modaldis+= '<span id="myModalLabel" class="caption caption-subject font-blue-sharp bold uppercase" style="text-align: center"><i class="fa fa-plus font-blue-sharp"></i> Add Country: Country details</span>';
            modaldis+= '</div>';
        ...
        $(".editRecord").click(function(){
            ...
            modaldis+= '<div class="modal-header">';
            modaldis+= '<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>';
            modaldis+= '<span id="myModalLabel" class="caption caption-subject font-blue-sharp bold uppercase" style="text-align: center"><i class="fa fa-edit font-blue-sharp"></i> Update Country: Country details</span>';
            modaldis+= '</div>';
            modaldis+= '<div class="modal-body">';
            modaldis+= ' </div>';
            modaldis+= '</div>';
        ...
        $(".deleteRecord").click(function(){
            ...
            $("#yes").click(function(){
                ...
                $.get("<?php echo url('countries') ?>/"+id1,function(data){
                        ...
                        @if(count($countries)>0)
                            @foreach($countries as $reg)
                                <tr class="odd gradeX">
                                    ...
                                    <td class="text-center" id="{{$reg->id}}">
