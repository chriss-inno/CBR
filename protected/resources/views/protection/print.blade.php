...
<div class="portlet-body form">
    ...
    <div class="row">
        <div class="col-md-12 col-xs-12 col-lg-12">
            <table class="table table-bordered">
                <tr>
                    <th colspan="4" style="background-color: #000" align="center"><span style="background-color: #fff;" class="col-md-8 col-md-offset-2 text-center">INDIVIDUAL PROTECTION SCREENING AND NEEDS IDENTIFICATION FORM </span></th>
                </tr>
                <tr>
            ...
            <table class="table table-bordered">
                <tr>
                    <th colspan="4" style="background-color: #000" align="center"><span style="color: #fff;" class="col-md-8 col-md-offset-2 text-center">IDENTIFIED PROTECTION NEEDS </span></th>
                </tr>
                <tr>
                    <td class="col-sm-3">
            ...
            <table class="table table-bordered">
                <tr>
                    <th style="background-color: #000" align="center"><span style="color: #fff;" class="col-md-8 col-md-offset-2 text-center">HISTORY OF CLIENT </span></th>
                </tr>
                <tr>
