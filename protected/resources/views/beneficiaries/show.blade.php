        ...
        <div class="form-body">
            <div class="form-group" id="itemsdispatch">
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-8 col-lg-8">
                            ...
                            <input type="text" class="form-control" name="progress_number" id="progress_number" value="{{$beneficiary->progress_number}}" disabled>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="full_name" id="full_name" value="{{$beneficiary->full_name}}" disabled>
                </div>
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-4 col-sm-4 col-xs-4 col-lg-4">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-4 col-lg-4">
                            <label>Age</label>
                            <input type="text" class="form-control" name="age" id="age" value="{{$beneficiary->age}}" disabled>
                        </div>
                        <div class="col-md-4 col-sm-4 col-xs-4 col-lg-4">
                            <label>Code</label>
                            <input type="text" class="form-control" name="code" id="code" value="{{$beneficiary->code}}" disabled>
                        </div>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-4 col-sm-4 col-xs-4 col-lg-4">
                            ...
                            <input type="text" class="form-control" name="family_size" id="family_size" value="{{$beneficiary->family_size}}" disabled>
                        </div>
                        <div class="col-md-4 col-sm-4 col-xs-4 col-lg-4">
                            <label>Number of females</label>
                            <input type="text" class="form-control" name="number_females" id="number_females" value="{{$beneficiary->number_females}}" disabled>
                        </div>
                        <div class="col-md-4 col-sm-4 col-xs-4 col-lg-4">
                            <label>Number of males</label>
                            <input type="text" class="form-control" name="number_male" id="number_male" value="{{$beneficiary->number_male}}" disabled>
                        </div>
