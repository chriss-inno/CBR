...
@section('custom-scripts')
    ...
    <script>
        ...
        $(".addRecord").click(function(){
            ...
            modaldis+= '<span id="myModalLabel" class="caption caption-subject font-blue-sharp bold uppercase" style="text-align: center"><i class="fa fa-plus font-blue-sharp"></i>Rehabilitation progress</span>';
            modaldis+= '</div>';
        ...
        $(".editRecord").click(function(){
            ...
            $("#myModal").modal("show");
            $(".modal-body").html("<h3><i class='fa fa-spin fa-spinner '></i><span>loading...</span><h3>");
            $(".modal-body").load("<?php echo url("rehabilitation/services/progress/edit") ?>/"+id1);
            $("#myModal").on('hidden.bs.modal',function(){
                $("#myModal").remove();
            })
        ...
        $(".deleteRecord").click(function(){
            ...
            $("#yes").click(function(){
                ...
                $.get("<?php echo url('rehabilitation/services/progress/remove') ?>/"+id1,function(data){
        ...
        <div class="col-md-12">
            ...
            <div class="portlet-body" >
                ...
                <fieldset class="scheduler-border" style="margin-top: 10px">
                    <legend class="scheduler-border">Client Progress</legend>
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-8 pull-right">
