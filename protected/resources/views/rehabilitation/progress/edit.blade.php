...
<div class="portlet light bordered">
    <div class="portlet-body form">
        {!! Form::open(array('url'=>'rehabilitation/services/progress/edit','role'=>'form','id'=>'DepartmentFormUN')) !!}
        <div class="form-body">
            <div class="form-group" id="itemsdispatch">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-4 col-xs-4 col-lg-4">
                            ...
                            <div class="input-group input-medium date date-picker" data-date="" data-date-format="yyyy-mm-dd" data-date-viewmode="years" data-date-end-date="+0d">
                                <input type="text" class="form-control" name="attendance_date" id="attendance_date" readonly value="{{$attendances->attendance_date}}">
                ...
                <div class="form-group">
                    <label>Treatment/ assistance provided </label>
                    <textarea class="wysihtml5 form-control" rows="5" name="assistance_provided" id="assistance_provided">{{$attendances->assistance_provided}}</textarea>
                </div>
                <div class="form-group">
                    <label>Progress </label>
                    <textarea class="wysihtml5 form-control" rows="5" name="progress" id="progress">{{$attendances->progress}}</textarea>
                </div>
                <div class="form-group">
                    <label>Remarks</label>
