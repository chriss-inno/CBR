                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-4 col-xs-4 col-lg-4">
                            ...
                            <div class="input-group input-medium date date-picker" data-date="" data-date-format="yyyy-mm-dd" data-date-viewmode="years" data-date-end-date="+0d">
                                <input type="text" class="form-control" name="date_registration" id="date_registration" readonly>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-4 col-sm-4 col-xs-4 col-lg-4">
                            ...
                            <input type="text" class="form-control" name="family_size" id="family_size">
                        </div>
                        <div class="col-md-4 col-sm-4 col-xs-4 col-lg-4">
                            <label>Number of females</label>
                            <input type="text" class="form-control" name="number_females" id="number_females">
                        </div>
                        <div class="col-md-4 col-sm-4 col-xs-4 col-lg-4">
                            <label>Number of males</label>
                            <input type="text" class="form-control" name="number_male" id="number_male">
                        </div>
