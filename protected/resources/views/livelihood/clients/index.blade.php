...
@section('custom-scripts')
    ...
    <script>
        ...
        $(".showRecord").click(function(){
            ...
            $(".modal-body").load("<?php echo url("livelihood/clients/") ?>/"+id1);
        ...
        $(".addRecord").click(function(){
            ...
            $("#myModal").modal("show");
            $(".modal-body").html("<h3><i class='fa fa-spin fa-spinner '></i><span>loading...</span><h3>");
            $(".modal-body").load("<?php echo url("livelihood/clients/create") ?>");
            $("#myModal").on('hidden.bs.modal',function(){
                $("#myModal").remove();
            })
        ...
        $(".editRecord").click(function(){
            ...
            $("#myModal").modal("show");
            $(".modal-body").html("<h3><i class='fa fa-spin fa-spinner '></i><span>loading...</span><h3>");
            $(".modal-body").load("<?php echo url("livelihood/clients/") ?>/"+id1+"/edit");
            $("#myModal").on('hidden.bs.modal',function(){
                $("#myModal").remove();
            })
...
@section('breadcrumb')
    <ul class="page-breadcrumb ">
        ...
        <li>
            <a href="{{url('livelihood/clients')}}"> Livelihoods Tracking </a>
            <i class="fa fa-angle-right"></i>
        </li>
        <li>
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase"> Clients Management </span>
                    </div>
                    ...
                    @if(count($clients )>0)
                        @foreach($clients as $client)
                            <tr class="odd gradeX">
                                <td> {{$count++}} </td>
                                <td>
                                    <?php echo $client->progress_number; ?>
                                </td>
                                <td>
                                    <?php echo $client->full_name; ?>
                                </td>
                                <td>
                                    <?php echo $client->category; ?>
                                </td>
                                <td>
