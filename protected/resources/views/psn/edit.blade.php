        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    {!! Form::open(array('url'=>'psn/assessment/edit','role'=>'form','id'=>'DepartmentFormUN')) !!}
                    <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-4 col-sm-4">
                                                ...
                                                <input type="text" class="form-control" name="ration_card" id="ration_card" placeholder="Enter ration_card" value="{{$assessment->ration_card}}" >
                                            </div>
                                            <div class="col-md-4 col-sm-4">
                                                <label for="last_name">Family size: </label>
                                                <input type="text" class="form-control" name="family_size" id="family_size" placeholder="Enter family_size" value="{{$assessment->family_size}}" >
                                            </div>
                                            <div class="col-md-4 col-sm-4">
                                                <label for="middle_name">progress number</label>
                                                <input type="text" class="form-control" name="progress_number" id="progress_number" placeholder="Enter progress_number" value="{{$assessment->progress_number}}" >
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6">
                                                ...
                                                <input type="text" class="form-control" name="foster_care" id="foster_care" value="{{$assessment->foster_care}}" >
                                            </div>
                                            <div class="col-md-6 col-sm-6">
                                                <label for="last_name">Family relationship: </label>
                                                <input type="text" class="form-control" name="family_relationship" id="family_relationship" value="{{$assessment->family_relationship}}" >
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6">
                                                ...
                                                <select class="form-control" name="nature_case" onchange="showDivNaration(this);">
                                                    @if($assessment->nature_case !="" )
                                                    <option value="{{$assessment->nature_case}}" selected>{{$assessment->nature_case}}</option>
                                                        @else
                                                        <option value="">--Select--</option>
                                                    @endif
                                            ...
                                            <div class="col-md-6 col-sm-6" id="caseNarrations">
                                                   @if($assessment->nature_case == "Old Case")
                                                        <label for="last_name">if old case what was it?</label>
                                                        <input type="text" class="form-control" name="nature_case_other" id="nature_case_other" value="{{$assessment->nature_case_other}}">
                                                       @endif
                                            </div>
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body form">
                                    <div class="form-group">
                                        ...
                                        <textarea class="wysihtml5 form-control" rows="4" name="hist_problem" id="hist_problem">{{$assessment->hist_problem}}</textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>When did  it happen?</label>
                                        <textarea class="wysihtml5 form-control" rows="4" name="hist_problem_when" id="hist_problem_when">{{$assessment->hist_problem_when}}</textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>How  did  it  happen /causes of the problem:</label>
                                        <textarea class="wysihtml5 form-control" rows="4" name="hist_causes" id="hist_causes">{{$assessment->hist_causes}}</textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>What are the related problems caused by the initial problem?</label>
                                        <textarea class="wysihtml5 form-control" rows="4" name="hist_problem_related" id="hist_problem_related">{{$assessment->hist_problem_related}}</textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>Other relevant information: </label>
                                        <textarea class="wysihtml5 form-control" rows="4" name="hist_relevant" id="hist_relevant">{{$assessment->hist_relevant}}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body form">
                                        ...
                                        <select multiple="multiple" class="form-control multi-select" id="my_multi_select2" name="service_name[]">
                                           @if(is_object($assessment->services) && $assessment->services != null )
                                               @foreach($assessment->services as $serv)
                                                <option selected>{{$serv->service_name}}</option>
                                                @endforeach
                                            @endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="wysihtml5 form-control" rows="4" name="community_initiatives " id="community_initiatives">{{$assessment->community_initiatives}}</textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>Action planning:</label>
                                        <textarea class="wysihtml5 form-control" rows="4" name="action_planning" id="action_planning">{{$assessment->action_planning}}</textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>General Remarks (case conference): </label>
                                        <textarea class="wysihtml5 form-control" rows="4" name="general_remarks" id="general_remarks">{{$assessment->general_remarks}}</textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>Follow up:  </label>
                                        <textarea class="wysihtml5 form-control" rows="4" name="follow_up" id="follow_up">{{$assessment->follow_up}}</textarea>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
                                                <label>Name of Caregiver: </label>
                                                <input type="text" class=" form-control"  name="caregiver_name" id="caregiver_name" value="{{$assessment->caregiver_name}}">
                                            </div>
                                            <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
                                                <label>Date</label>
                                                <div class="input-group input-medium date date-picker" data-date="" data-date-format="yyyy-mm-dd" data-date-viewmode="years" data-date-end-date="+0d">
                                                    <input type="text" class="form-control" name="caregiver_date" id="caregiver_date" readonly value="{{$assessment->caregiver_date}}">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
                                                ...
                                                <input type="text" class=" form-control"  name="interviewer_name" id="interviewer_name" value="{{$assessment->interviewer_name}}">
                                            </div>
                                            <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
                                                <label>Date</label>
                                                <div class="input-group input-medium date date-picker" data-date="" data-date-format="yyyy-mm-dd" data-date-viewmode="years" data-date-end-date="+0d">
                                                    <input type="text" class="form-control" name="interviewer_date" id="interviewer_date" readonly value="{{$assessment->interviewer_date}}">
                                                        <span class="input-group-btn">
                                                            <button class="btn default" type="button">
                                                                <i class="fa fa-calendar"></i>
                                                            </button>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
                                                ...
                                                <input type="text" class=" form-control"  name="reviewer_name" id="reviewer_name" value="{{$assessment->reviewer_name}}">
                                            </div>
                                            <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
                                                <label>Date </label>
                                                <div class="input-group input-medium date date-picker" data-date="" data-date-format="yyyy-mm-dd" data-date-viewmode="years" data-date-end-date="+0d">
                                                    <input type="text" class="form-control" name="reviewer_date" id="reviewer_date" readonly value="{{$assessment->reviewer_date}}">
                                                        <span class="input-group-btn">
                                                            <button class="btn default" type="button">
                                                                <i class="fa fa-calendar"></i>
                                                            </button>
