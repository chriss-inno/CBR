            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">Rehabilitation service: Import</span>
                    </div>
                ...
                <div class="portlet-body">
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-body form">
                            ...
                            {!! Form::open(array('url'=>'excel/rehabilitation/progress','role'=>'form','id'=>'DepartmentFormUN1','files'=>true)) !!}
                            <div class="form-body">
                                <div class="form-group">
                                    <label>Import rehabilitation progress details from MS Excel <a href={{asset("assets/templates/rehabilitation_progress_template.xls")}}>Download template here</a> </label>
                                    <input TYPE="file" class="form-control" name="clients_file" id="clients_file">
                                    @if($errors->first('clients_file') !="")
                                        <span class=" error">{{ $errors->first('clients_file') }}</span>
                                    @endif
                                ...
                                <div class="row text-center">
                                    <div class="col-md-4 col-sm-4">
                                        <button type="submit" class="btn btn-success btn-block"><i class="fa fa-save"></i> Import rehabilitation progress details</button>
                                    </div>
