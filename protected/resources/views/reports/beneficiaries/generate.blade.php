                ...
                <div class="portlet-body">
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-body form">
                            {!! Form::open(array('url'=>'reports/beneficiaries/generate','role'=>'form','id'=>'GenerateFrm','files'=>true)) !!}
                            <div class="form-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="category" id="category" class="form-control">
                                                <option value="">All</option>
                                                @foreach(\App\Beneficiary::orderBy('category')->groupBy('category')->get() as $cat)
